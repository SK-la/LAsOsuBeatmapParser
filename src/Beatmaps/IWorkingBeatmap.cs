...
namespace LAsOsuBeatmapParser.Beatmaps
{
    ...
    ///     - Create a playable <see cref="Beatmap" /> via
    ///     <see cref="GetPlayableBeatmap(IRulesetInfo,System.Collections.Generic.IReadOnlyList{Mod})" />.
    /// </summary>
    public interface IWorkingBeatmap
    {
        ...
        /// <summary>
        ///     Constructs a playable <see cref="IBeatmap" /> from <see cref="Beatmap" /> using the applicable converters for a
        ///     specific <see cref="IRulesetInfo" />.
        ///     <para>
        ///         The returned <see cref="IBeatmap" /> is in a playable state - all <see cref="HitObject" /> and
        ///         <see cref="BeatmapDifficulty" /> <see cref="Mod" />s
        ...
        ///     <see
        ///         cref="GetPlayableBeatmap(IRulesetInfo,System.Collections.Generic.IReadOnlyList{Mod},System.Threading.CancellationToken)" />
        ///     overload instead.
        /// </remarks>
        ...
        /// <exception cref="BeatmapInvalidForRulesetException">
        ///     If <see cref="Beatmap" /> could not be converted to
