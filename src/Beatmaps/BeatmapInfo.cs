...
namespace LAsOsuBeatmapParser.Beatmaps
{
    ...
    ///     This should generally include anything which is required to be filtered on at song select, or anything pertaining
    ///     to storage of beatmaps in the client.
    /// </summary>
    public class BeatmapInfo : IBeatmapInfo, IHasRealmPrimaryKey, IHasOnlineID
    {
        ...
        {
            return $"{Metadata.Artist} - {Metadata.Title} [{DifficultyName}]";
        }
        ...
        {
            return obj is IBeatmapInfo other && Equals(other);
        }
