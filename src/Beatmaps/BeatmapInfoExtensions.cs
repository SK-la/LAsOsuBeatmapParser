...
public static class BeatmapInfoExtensions
{
    ...
    public static double GetStarRating(this IBeatmapInfo beatmapInfo) => beatmapInfo.StarRating;
    ...
    public static double GetBPM(this IBeatmapInfo beatmapInfo) => beatmapInfo.BPM;
    ...
    public static double GetLength(this IBeatmapInfo beatmapInfo) => beatmapInfo.Length;
    ...
    public static string GetHash(this IBeatmapInfo beatmapInfo) => beatmapInfo.Hash;
    ...
    public static string GetMD5Hash(this IBeatmapInfo beatmapInfo) => beatmapInfo.MD5Hash;
    ...
    public static int GetTotalObjectCount(this IBeatmapInfo beatmapInfo) => beatmapInfo.TotalObjectCount;
    ...
    public static int GetEndTimeObjectCount(this IBeatmapInfo beatmapInfo) => beatmapInfo.EndTimeObjectCount;
    ...
    public static bool IsFromSameBeatmapSet(this IBeatmapInfo beatmapInfo, IBeatmapInfo other)
        => beatmapInfo.BeatmapSet?.Equals(other.BeatmapSet) == true;
    ...
    public static string GetDisplayTitleRomanised(this IBeatmapInfo beatmapInfo)
        => $"{beatmapInfo.Metadata.ArtistUnicode} - {beatmapInfo.Metadata.TitleUnicode}";
}
